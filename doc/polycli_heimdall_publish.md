...
Broadcast a signed TxRaw (base64 or hex).

```bash
polycli heimdall publish <TX> [flags]
```
...
```bash
  ...
  -h, --help                help for publish
      --mode string         broadcast mode (default "BROADCAST_MODE_SYNC")
      --yes                 confirm broadcast (required)
```
