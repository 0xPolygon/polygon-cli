# `polycli heimdall validator is-old-stake-tx`
...
Check whether an L1 stake event was already replayed.

```bash
polycli heimdall validator is-old-stake-tx <TX_HASH> <LOG_INDEX> [flags]
```
...
```bash
  ...
  -h, --help                help for is-old-stake-tx
```
