# `polycli heimdall wallet change-password`
...
Change a keystore entry's password.

```bash
polycli heimdall wallet change-password <address-or-file> [flags]
```
...
```bash
  -h, --help                       help for change-password
      ...
      --new-password string        new keystore password
      --new-password-file string   file containing the new keystore password
