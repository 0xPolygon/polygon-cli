# `polycli heimdall estimate signer-update`
...
Rotate validator signer pubkey (MsgSignerUpdate, L1-mirroring).

```bash
polycli heimdall estimate signer-update [flags]
```
...
```bash
      ...
      --from-msg string             MsgSignerUpdate.from address (default: signer)
  ...
  -h, --help                        help for signer-update
      ...
      --new-signer-pub-key string   new signer pubkey (hex)
