# `polycli heimdall estimate stake-update`
...
Update validator stake (MsgStakeUpdate, L1-mirroring).

```bash
polycli heimdall estimate stake-update [flags]
```
...
```bash
      ...
      --from-msg string          MsgStakeUpdate.from address (default: signer)
  ...
  -h, --help                     help for stake-update
      ...
      --new-amount string        new stake amount (decimal string)
