# `polycli heimdall estimate span-backfill`
...
Trigger span backfill (MsgBackfillSpans).

```bash
polycli heimdall estimate span-backfill [flags]
```
...
```bash
      ...
      --bor-chain-id string       bor chain id
  ...
  -h, --help                      help for span-backfill
      ...
      --latest-bor-span-id uint   latest bor span id
      --latest-span-id uint       latest heimdall span id
