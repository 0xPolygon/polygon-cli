# `polycli heimdall wallet public-key`
...
Print the secp256k1 public key for a key.

```bash
polycli heimdall wallet public-key [address] [flags]
```

## Flags

```bash
      --compressed             print only the compressed form
  -h, --help                   help for public-key
      ...
      --uncompressed           print only the uncompressed form
