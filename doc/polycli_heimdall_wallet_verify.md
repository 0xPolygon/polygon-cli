# `polycli heimdall wallet verify`
...
```bash
polycli heimdall wallet verify <address> <message-or-hash> <signature> [flags]
```
...
```bash
  -h, --help   help for verify
      --raw    verify against a 32-byte hash (no EIP-191 framing)
```
