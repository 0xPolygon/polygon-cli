...
Convert an address between 0x-hex and bech32.

```bash
polycli heimdall util addr <value> [flags]
```

## Flags

```bash
  -a, --all          print both hex and bech32 forms
  -h, --help         help for addr
      --hrp string   bech32 human-readable part (default "cosmos")
```
