...
```bash
$ polycli loadtest --verbosity 700 --chain-id 1256 --concurrency 1 --requests 1000 --rate-limit 1 --mode t --rpc-endpoint http://localhost:8888
```
...
```bash
$ polycli loadtest --verbosity 700 --chain-id 1256 --concurrency 1 --requests 50 --rate-limit 0.5  --mode f --function 164 --iterations 25078 --rpc-endpoint http://private.validator-001.devnet02.pos-v3.polygon.private:8545
```
...
4. Run the loadtester to enure it deploys and runs successfully
   - `$ polycli loadtest --verbosity 700 --rpc-endpoint http://127.0.0.1:8541`
...
```bash
  ...
  -r, --rpc-endpoint string                        The RPC endpoint (default "http://localhost:8545")
