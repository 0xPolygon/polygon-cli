# `polycli heimdall estimate topup`
...
Credit validator fee balance (MsgTopupTx, L1-mirroring).

```bash
polycli heimdall estimate topup [flags]
```
...
```bash
      ...
      --fee-amount string        topup fee amount (decimal string)
  ...
  -h, --help                     help for topup
      ...
      --tx-hash string           L1 transaction hash (32 bytes hex)
      --user string              user address being topped up
```
