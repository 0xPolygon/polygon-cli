...
```bash
      --checkpoint-stride uint      number of L2 blocks per checkpoint (10000 on mainnet; override for local testnets) (default 10000)
  -h, --help                        help for exit-proof
      ...
      --tx-hash string              burn transaction hash on L2
```
