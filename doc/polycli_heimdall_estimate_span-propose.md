# `polycli heimdall estimate span-propose`
...
Propose a new bor span (MsgProposeSpan).

```bash
polycli heimdall estimate span-propose [flags]
```
...
```bash
      ...
      --bor-chain-id string      bor chain id (e.g. 137)
  ...
  -h, --help                     help for span-propose
      ...
      --seed string              32-byte seed hash (hex)
      --seed-author string       seed author address (default: proposer)
      --sequence uint            override fetched sequence
      --sign-mode string         signing mode (direct|amino-json) (default "direct")
      --span-id uint             span id to propose
