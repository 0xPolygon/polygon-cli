...
func init() {
	...
	f.Float64VarP(&params.PoolFees, "pool-fees", "f", float64(uniswapv3loadtest.StandardTier), "trading fees charged on each swap or trade made within a UniswapV3 liquidity pool (e.g. 0.3 means 0.3%)")
