...
// by the nonce value.
func exactInputSingleSwap(tops *bind.TransactOpts, swapRouter *uniswapv3.SwapRouter02, poolConfig uniswapv3loadtest.PoolConfig, recipient common.Address, nonce uint64) error {
