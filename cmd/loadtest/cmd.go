...
v3, uniswapv3 - perform UniswapV3 swaps`)
	...
	f.StringVar(&cfg.ContractAddress, "contract-address", "", "contract address for --mode contract-call (requires --calldata or --calldata-file)")
	...
	f.StringVar(&cfg.ContractCallDataFile, "calldata-file", "", "path to a file with hex encoded calldata; use instead of --calldata for payloads too large for a shell argument (mutually exclusive with --calldata)")
