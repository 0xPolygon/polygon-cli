...
func _() {
	...
	_ = x[loadTestModeRandom-12]
	_ = x[loadTestModeRPC-13]
}

const _loadTestMode_name = ""

var _loadTestMode_index = [...]uint16{0, 23, 41, 57, 77, 92, 109, 126, 144, 176, 207, 225, 246, 264, 279}
