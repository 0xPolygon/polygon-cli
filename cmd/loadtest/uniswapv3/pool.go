...
func SetupLiquidityPool(ctx context.Context, c *ethclient.Client, tops *bind.TransactOpts, cops *bind.CallOpts, uniswapV3Config UniswapV3Config, poolConfig PoolConfig, recipient common.Address, blockUntilSuccessful contracts.BlockUntilSuccessfulFn) error {
	...
	if liquidity.Cmp(big.NewInt(0)) == 0 {
		if provideLiquidity(ctx, c, tops, cops, poolContract, poolConfig, recipient, uniswapV3Config.NonfungiblePositionManager.Contract, blockUntilSuccessful) != nil {
			return err
		}
	} else {
...
func createPool(ctx context.Context, c *ethclient.Client, tops *bind.TransactOpts, cops *bind.CallOpts, uniswapV3Config UniswapV3Config, poolConfig PoolConfig, blockUntilSuccessful contracts.BlockUntilSuccessfulFn) (*uniswapv3.IUniswapV3Pool, error) {
