...
func DeployUniswapV3(ctx context.Context, c *ethclient.Client, tops *bind.TransactOpts, cops *bind.CallOpts, knownAddresses UniswapV3Addresses, ownerAddress common.Address, blockblockUntilSuccessful contracts.BlockUntilSuccessfulFn) (config UniswapV3Config, err error) {
...
func deployOrInstantiateContract[T Contract](
	...
	call func(*T) error,
	blockUntilSuccessful contracts.BlockUntilSuccessfulFn,
