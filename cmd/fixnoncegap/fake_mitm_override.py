...
OVERRIDES = {
    ...
    # ("eth_getTransactionCount", _ser(["0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266", "latest"])): {"jsonrpc": "2.0", "id": 1, "result": "0xa"},
    ("eth_getTransactionCount", _ser(["0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266", "pending"])): {"jsonrpc": "2.0", "id": 1, "result": "0x100"},
}
