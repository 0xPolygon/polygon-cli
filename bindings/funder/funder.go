...
var FunderMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_amount\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[],\"name\":\"amount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"account\",\"type\":\"address\"}],\"name\":\"fundAccount\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address[]\",\"name\":\"accounts\",\"type\":\"address[]\"}],\"name\":\"fundAccounts\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]",
	Bin: "",
}
...
// FundAccount is a paid mutator transaction binding the contract method 0x5b6f032e.
//
// Solidity: function fundAccount(address account) returns()
func (_Funder *FunderTransactor) FundAccount(opts *bind.TransactOpts, account common.Address) (*types.Transaction, error) {
	return _Funder.contract.Transact(opts, "fundAccount", account)
}

// FundAccount is a paid mutator transaction binding the contract method 0x5b6f032e.
//
// Solidity: function fundAccount(address account) returns()
func (_Funder *FunderSession) FundAccount(account common.Address) (*types.Transaction, error) {
	return _Funder.Contract.FundAccount(&_Funder.TransactOpts, account)
}

// FundAccount is a paid mutator transaction binding the contract method 0x5b6f032e.
//
// Solidity: function fundAccount(address account) returns()
func (_Funder *FunderTransactorSession) FundAccount(account common.Address) (*types.Transaction, error) {
	return _Funder.Contract.FundAccount(&_Funder.TransactOpts, account)
}

// FundAccounts is a paid mutator transaction binding the contract method 0xb8e44fd9.
//
// Solidity: function fundAccounts(address[] accounts) returns()
func (_Funder *FunderTransactor) FundAccounts(opts *bind.TransactOpts, accounts []common.Address) (*types.Transaction, error) {
	return _Funder.contract.Transact(opts, "fundAccounts", accounts)
}

// FundAccounts is a paid mutator transaction binding the contract method 0xb8e44fd9.
//
// Solidity: function fundAccounts(address[] accounts) returns()
func (_Funder *FunderSession) FundAccounts(accounts []common.Address) (*types.Transaction, error) {
	return _Funder.Contract.FundAccounts(&_Funder.TransactOpts, accounts)
}

// FundAccounts is a paid mutator transaction binding the contract method 0xb8e44fd9.
//
// Solidity: function fundAccounts(address[] accounts) returns()
func (_Funder *FunderTransactorSession) FundAccounts(accounts []common.Address) (*types.Transaction, error) {
	return _Funder.Contract.FundAccounts(&_Funder.TransactOpts, accounts)
}
