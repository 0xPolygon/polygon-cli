...
var FunderMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"_amount\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"inputs\":[],\"name\":\"amount\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address[]\",\"name\":\"_accounts\",\"type\":\"address[]\"}],\"name\":\"bulkFund\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_account\",\"type\":\"address\"}],\"name\":\"fund\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"stateMutability\":\"payable\",\"type\":\"receive\"}]",
	Bin: "",
}
...
//
// Solidity: function bulkFund(address[] _accounts) returns()
func (_Funder *FunderTransactor) BulkFund(opts *bind.TransactOpts, _accounts []common.Address) (*types.Transaction, error) {
	return _Funder.contract.Transact(opts, "bulkFund", _accounts)
}

// BulkFund is a paid mutator transaction binding the contract method 0xa4626b85.
//
// Solidity: function bulkFund(address[] _accounts) returns()
func (_Funder *FunderSession) BulkFund(_accounts []common.Address) (*types.Transaction, error) {
	return _Funder.Contract.BulkFund(&_Funder.TransactOpts, _accounts)
}

// BulkFund is a paid mutator transaction binding the contract method 0xa4626b85.
//
// Solidity: function bulkFund(address[] _accounts) returns()
func (_Funder *FunderTransactorSession) BulkFund(_accounts []common.Address) (*types.Transaction, error) {
	return _Funder.Contract.BulkFund(&_Funder.TransactOpts, _accounts)
}

// Fund is a paid mutator transaction binding the contract method 0x23024408.
//
// Solidity: function fund(address _account) returns()
func (_Funder *FunderTransactor) Fund(opts *bind.TransactOpts, _account common.Address) (*types.Transaction, error) {
	return _Funder.contract.Transact(opts, "fund", _account)
}

// Fund is a paid mutator transaction binding the contract method 0x23024408.
//
// Solidity: function fund(address _account) returns()
func (_Funder *FunderSession) Fund(_account common.Address) (*types.Transaction, error) {
	return _Funder.Contract.Fund(&_Funder.TransactOpts, _account)
}

// Fund is a paid mutator transaction binding the contract method 0x23024408.
//
// Solidity: function fund(address _account) returns()
func (_Funder *FunderTransactorSession) Fund(_account common.Address) (*types.Transaction, error) {
	return _Funder.Contract.Fund(&_Funder.TransactOpts, _account)
}
